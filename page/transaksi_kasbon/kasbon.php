...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    if (isset($_POST['get_no_transaksi']) && isset($_POST['jenis_transaksi'])) {
        ...
        // Pastikan hanya mengambil transaksi dari "Penerimaan"
        if ($jenis_transaksi === "Penerimaan") {
            $query = $konektor->prepare("
                SELECT MAX(CAST(no_transaksi AS UNSIGNED)) AS max_code 
                FROM transaksi_bank 
            ...
            // Ambil nomor transaksi terbesar dari "Penerimaan", jika tidak ada, mulai dari 1
            $max_code = isset($row['max_code']) ? (int) $row['max_code'] : 0;
            $next_code = $max_code + 1;

            echo $next_code; // Kembalikan ke AJAX
        } else {
            echo ""; // Jika bukan "Penerimaan", kosongkan field
        }
        exit();
    }
}
...
<head>
    ...
    <title>Input Transaksi Kasbon</title>
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script>
function updateKodeTransaksi() {
    var jenisTransaksi = $("#jenis_transaksi").val(); 

    if (jenisTransaksi === "Penerimaan") {  // Hanya bekerja untuk Penerimaan
        $.ajax({
            url: "page/transaksi_kasbon/kasbon.php",
            type: "POST",
            data: { get_no_transaksi: 1, jenis_transaksi: jenisTransaksi },
            success: function(response) {
                console.log("Nomor Transaksi Baru (Penerimaan): " + response);
                $("#no_transaksi").val(response); // Menampilkan nomor transaksi baru
            },
            error: function() {
        ...
        $("#no_transaksi").val(""); // Kosongkan jika bukan "Penerimaan"
    }
}
</script>
    ...
    <input type="text" name="kode_transaksi" id="no_transaksi" class="form-control col-sm-9" readonly>
      ...
      <!-- <input type="hidden" name="no_transaksi" id="no_transaksi" value="<?= $kode_transaksi ?>" class="form-control col-sm-9"> -->
          ...
          <label for="nama" class="col-sm-2"><b>No Kas Bon</b></label>
            <input type="number" name="no_kasbon" id="no_kasbon" class="form-control col-sm-9" value="<?= $no_kasbon ?>" readonly>
          </div>
                ...
                function removeFormatFromSaldoInputs() {
                  ...
                  <div class="card-body">
                    <?php if ($total == $total2): ?>
                        ...
                        <a href="?page=transaksi_kasbon" class="btn btn-success">Transaksi Terbuat</a> 
                    <?php else: ?>
...
if (isset($_POST['simpan'])) {
  ...
  $saldo50 = $_POST['saldo50'];
    ...
    if((isset($_POST['simpan']))){
      ...
      VALUES('$status','$jenis_transaksi','$tanggal','$sumber_dana','$kode_transaksi','$kode_jenjang1','$nama_jenjang1','$kode_tahun','$tahun_ajaran','$keterangan1','$kode_akun','$nama_akun','$saldo1','$saldo2','$no_kasbon')";
      ...
      VALUES('$status','$jenis_transaksi','$tanggal','','$kode_transaksi','$kode_jenjang2','$nama_jenjang2','$kode_tahun','','$keterangan2','$kode_akun2','$nama_akun2','$saldo3','$saldo4','$no_kasbon')";
      ...
      VALUES('$status','$jenis_transaksi','$tanggal','','$kode_transaksi','$kode_jenjang3','$nama_jenjang3','$kode_tahun','','$keterangan3','$kode_akun3','$nama_akun3','$saldo5','$saldo6','$no_kasbon')";
      ...
      VALUES('$status','$jenis_transaksi','$tanggal','','$kode_transaksi','$kode_jenjang4','$nama_jenjang4','$kode_tahun','','$keterangan4','$kode_akun4','$nama_akun4','$saldo7','$saldo8','$no_kasbon')";
      ...
      VALUES('$status','$jenis_transaksi','$tanggal','','$kode_transaksi','$kode_jenjang5','$nama_jenjang5','$kode_tahun','','$keterangan5','$kode_akun5','$nama_akun5','$saldo9','$saldo10','$no_kasbon')";
      ...
      $insertquery6 = "INSERT INTO transaksi_bank (status, jenis_transaksi, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit, no_kasbon) 
      VALUES('$status','$jenis_transaksi','$tanggal','','$kode_transaksi','$kode_jenjang6','$nama_jenjang6','$kode_tahun','','$keterangan6','$kode_akun6','$nama_akun6','$saldo11','$saldo12','$no_kasbon')";
      ...
      $insertquery7 = "INSERT INTO transaksi_bank (status, jenis_transaksi, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit, no_kasbon) 
      VALUES('$status','$jenis_transaksi','$tanggal','','$kode_transaksi','$kode_jenjang7','$nama_jenjang7','$kode_tahun','','$keterangan7','$kode_akun7','$nama_akun7','$saldo13','$saldo14','$no_kasbon')";
      ...
      $insertquery8 = "INSERT INTO transaksi_bank (status, jenis_transaksi, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit, no_kasbon) 
      VALUES('$status','$jenis_transaksi','$tanggal','','$kode_transaksi','$kode_jenjang8','$nama_jenjang8','$kode_tahun','','$keterangan8','$kode_akun8','$nama_akun8','$saldo15','$saldo16','$no_kasbon')";
      ...
      $insertquery9 = "INSERT INTO transaksi_bank (status, jenis_transaksi, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit, no_kasbon) 
      VALUES('$status','$jenis_transaksi','$tanggal','','$kode_transaksi','$kode_jenjang9','$nama_jenjang9','$kode_tahun','','$keterangan9','$kode_akun9','$nama_akun9','$saldo17','$saldo18','$no_kasbon')";
      ...
      $insertquery10 = "INSERT INTO transaksi_bank (status, jenis_transaksi, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit, no_kasbon) 
      VALUES('$status','$jenis_transaksi','$tanggal','','$kode_transaksi','$kode_jenjang10','$nama_jenjang10','$kode_tahun','','$keterangan10','$kode_akun10','$nama_akun10','$saldo19','$saldo20','$no_kasbon')";
      ...
      $insertquery11 = "INSERT INTO transaksi_bank (status, jenis_transaksi, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit, no_kasbon) 
      VALUES('$status','$jenis_transaksi','$tanggal','','$kode_transaksi','$kode_jenjang11','$nama_jenjang11','$kode_tahun','','$keterangan11','$kode_akun11','$nama_akun11','$saldo21','$saldo22','$no_kasbon')";
      ...
      $insertquery12 = "INSERT INTO transaksi_bank (status, jenis_transaksi, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit, no_kasbon) 
      VALUES('$status','$jenis_transaksi','$tanggal','','$kode_transaksi','$kode_jenjang12','$nama_jenjang12','$kode_tahun','','$keterangan12','$kode_akun12','$nama_akun12','$saldo23','$saldo24','$no_kasbon')";
      ...
      $insertquery13 = "INSERT INTO transaksi_bank (status, jenis_transaksi, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit, no_kasbon) 
      VALUES('$status','$jenis_transaksi','$tanggal','','$kode_transaksi','$kode_jenjang13','$nama_jenjang13','$kode_tahun','','$keterangan13','$kode_akun13','$nama_akun13','$saldo25','$saldo26','$no_kasbon')";
      ...
      $insertquery14 = "INSERT INTO transaksi_bank (status, jenis_transaksi, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit, no_kasbon) 
      VALUES('$status','$jenis_transaksi','$tanggal','','$kode_transaksi','$kode_jenjang14','$nama_jenjang14','$kode_tahun','','$keterangan14','$kode_akun14','$nama_akun14','$saldo27','$saldo28','$no_kasbon')";
      ...
      $insertquery15 = "INSERT INTO transaksi_bank (status, jenis_transaksi, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit, no_kasbon) 
      VALUES('$status','$jenis_transaksi','$tanggal','','$kode_transaksi','$kode_jenjang15','$nama_jenjang15','$kode_tahun','','$keterangan15','$kode_akun15','$nama_akun15','$saldo29','$saldo30','$no_kasbon')";
      ...
      $insertquery16 = "INSERT INTO transaksi_bank (status, jenis_transaksi, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit, no_kasbon) 
      VALUES('$status','$jenis_transaksi','$tanggal','','$kode_transaksi','$kode_jenjang16','$nama_jenjang16','$kode_tahun','','$keterangan16','$kode_akun16','$nama_akun16','$saldo31','$saldo32','$no_kasbon')";
      ...
      $insertquery17 = "INSERT INTO transaksi_bank (status, jenis_transaksi, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit, no_kasbon) 
      VALUES('$status','$jenis_transaksi','$tanggal','','$kode_transaksi','$kode_jenjang17','$nama_jenjang17','$kode_tahun','','$keterangan17','$kode_akun17','$nama_akun17','$saldo33','$saldo34','$no_kasbon')";
      ...
      $insertquery18 = "INSERT INTO transaksi_bank (status, jenis_transaksi, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit, no_kasbon) 
      VALUES('$status','$jenis_transaksi','$tanggal','','$kode_transaksi','$kode_jenjang18','$nama_jenjang18','$kode_tahun','','$keterangan18','$kode_akun18','$nama_akun18','$saldo35','$saldo36','$no_kasbon')";
      ...
      $insertquery19 = "INSERT INTO transaksi_bank (status, jenis_transaksi, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit, no_kasbon) 
      VALUES('$status','$jenis_transaksi','$tanggal','','$kode_transaksi','$kode_jenjang19','$nama_jenjang19','$kode_tahun','','$keterangan19','$kode_akun19','$nama_akun19','$saldo37','$saldo38','$no_kasbon')";
      ...
      $insertquery20 = "INSERT INTO transaksi_bank (status, jenis_transaksi, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit, no_kasbon) 
      VALUES('$status','$jenis_transaksi','$tanggal','','$kode_transaksi','$kode_jenjang20','$nama_jenjang20','$kode_tahun','','$keterangan20','$kode_akun20','$nama_akun20','$saldo39','$saldo40','$no_kasbon')";
      ...
      $insertquery21 = "INSERT INTO transaksi_bank (status, jenis_transaksi, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit, no_kasbon) 
      VALUES('$status','$jenis_transaksi','$tanggal','','$kode_transaksi','$kode_jenjang21','$nama_jenjang21','$kode_tahun','','$keterangan21','$kode_akun21','$nama_akun21','$saldo41','$saldo42','$no_kasbon')";
      ...
      $insertquery22 = "INSERT INTO transaksi_bank (status, jenis_transaksi, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit, no_kasbon) 
      VALUES('$status','$jenis_transaksi','$tanggal','','$kode_transaksi','$kode_jenjang22','$nama_jenjang22','$kode_tahun','','$keterangan22','$kode_akun22','$nama_akun22','$saldo43','$saldo44','$no_kasbon')";
      ...
      $insertquery23 = "INSERT INTO transaksi_bank (status, jenis_transaksi, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit, no_kasbon) 
      VALUES('$status','$jenis_transaksi','$tanggal','','$kode_transaksi','$kode_jenjang23','$nama_jenjang23','$kode_tahun','','$keterangan23','$kode_akun23','$nama_akun23','$saldo45','$saldo46','$no_kasbon')";
      ...
      $insertquery24 = "INSERT INTO transaksi_bank (status, jenis_transaksi, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit, no_kasbon) 
      VALUES('$status','$jenis_transaksi','$tanggal','','$kode_transaksi','$kode_jenjang24','$nama_jenjang24','$kode_tahun','','$keterangan24','$kode_akun24','$nama_akun24','$saldo47','$saldo48','$no_kasbon')";
      ...
      $insertquery25 = "INSERT INTO transaksi_bank (status, jenis_transaksi, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit, no_kasbon) 
      VALUES('$status','$jenis_transaksi','$tanggal','','$kode_transaksi','$kode_jenjang25','$nama_jenjang25','$kode_tahun','','$keterangan25','$kode_akun25','$nama_akun25','$saldo49','$saldo50','$no_kasbon')";
...
?>        
      ...
      window.location.href="?page=transaksi_kasbon";
      </script>                       
    <?php
