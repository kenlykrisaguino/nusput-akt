...
$query_header = $konektor->query("SELECT * FROM transaksi_bank WHERE jenis_transaksi = 'Penerimaan' AND no_transaksi = '$no_transaksi' LIMIT 1");
...
$query = $konektor->query("SELECT * FROM transaksi_bank WHERE jenis_transaksi = 'Penerimaan' AND no_transaksi = '$no_transaksi' AND (sumber_dana IS NULL OR sumber_dana = '')");
...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            Detail Transaksi (Penerimaan - <?php echo $no_transaksi; ?>)
            </h3>
        </div>    
            ...
            <div class="table-responsive">    
                <div class="body">
                    ...
                    <label><b>Jenis Transaksi</b></label>
                        ...
                        <label><b>No Kas Bon</b></label>
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" name="no_kasbon" readonly value="<?php echo $tampil_header['no_kasbon']; ?>" class="form-control"/>
                            </div>
                        </div>
                        <br>
                        ...
                        <a href="?page=transaksi_kasbon" class="btn btn-info">Kembali</a>     
                    </form>
                </div>
            </div>
        </div>
