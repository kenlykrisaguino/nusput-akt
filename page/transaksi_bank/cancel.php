...
if (isset($_GET['no_transaksi']) && isset($_GET['jenis_transaksi'])) {
    ...
    $cancel_query = "UPDATE transaksi_bank SET status = 0 WHERE no_transaksi = '$no_transaksi' AND jenis_transaksi = '$jenis_transaksi'";
    ...
    if ($konektor->query($cancel_query) === TRUE) {
        ...
        echo 'window.location.href="?page=transaksi_bank&aksi=data";';
        echo '</script>';
    } else {
