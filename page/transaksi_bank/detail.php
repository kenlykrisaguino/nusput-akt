...
$query_header = $konektor->query("SELECT * FROM transaksi_bank WHERE jenis_transaksi = '$jenis_transaksi' AND no_transaksi = '$no_transaksi' LIMIT 1");
...
$query = $konektor->query("SELECT * FROM transaksi_bank WHERE jenis_transaksi = '$jenis_transaksi' AND no_transaksi = '$no_transaksi' AND (sumber_dana IS NULL OR sumber_dana = '')");
