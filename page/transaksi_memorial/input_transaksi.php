...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['get_no_transaksi'])) {
    ...
    $query = $konektor->query("SELECT MAX(CAST(no_transaksi AS UNSIGNED)) AS max_code FROM transaksi_memorial");
...
<head>
    ...
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                url: "/aktnusaputera/page/transaksi_memorial/input_transaksi.php",
                type: "POST",
...
<body>
    ...
    <div class="card-header py-3">
        <h3 class="m-0 font-weight-bold text-primary">Penjurnalan Memorial</h3>
    </div>
        <div class="row">
        <div class="col-md-12">
    ...
    <div class="form-group row">
        ...
        <script>
            var selectTahun = document.getElementById("kode_tahun");
            var inputTahunAjaran = document.getElementById("tahun_ajaran");

            selectTahun.addEventListener("change", function () {
                var selectedOption = selectTahun.options[selectTahun.selectedIndex];
                inputTahunAjaran.value = selectedOption.getAttribute("data-tahun");
            });
        </script>

        <div class="form-group row" style="display: none;">
        <label for="nama" class="col-sm-2"><b>Status</b></label>
          <input type="text" name="status" id="status" class="form-control col-sm-9" value="1" readonly>
        </div>
          ...
          <hr>
            ...
            <option value="<?= $kode_akun ?>" data-bank13="<?= $akun ?>" data-saldo-normal13="<?= $saldo_normal13 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo26" id="saldo26" oninput="formatNumber(this); calculateTotal();" ></th>
            ...
            <option value="<?= $kode_akun ?>" data-bank14="<?= $akun ?>" data-saldo-normal14="<?= $saldo_normal14 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo27" id="saldo27" oninput="formatNumber(this); calculateTotal();" ></th>
              <th><input style="text-align:center" type="text" class="form-control" name="saldo28" id="saldo28" oninput="formatNumber(this); calculateTotal();" ></th>
            ...
            <option value="<?= $kode_akun ?>" data-bank15="<?= $akun ?>" data-saldo-normal15="<?= $saldo_normal15 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo29" id="saldo29" oninput="formatNumber(this); calculateTotal();" ></th>
              <th><input style="text-align:center" type="text" class="form-control" name="saldo30" id="saldo30" oninput="formatNumber(this); calculateTotal();" ></th>
            ...
            <option value="<?= $kode_akun ?>" data-bank16="<?= $akun ?>" data-saldo-normal16="<?= $saldo_normal16 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo31" id="saldo31" oninput="formatNumber(this); calculateTotal();" ></th>
              <th><input style="text-align:center" type="text" class="form-control" name="saldo32" id="saldo32" oninput="formatNumber(this); calculateTotal();" ></th>
            ...
            <option value="<?= $kode_akun ?>" data-bank17="<?= $akun ?>" data-saldo-normal17="<?= $saldo_normal17 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo33" id="saldo33" oninput="formatNumber(this); calculateTotal();" ></th>
              <th><input style="text-align:center" type="text" class="form-control" name="saldo34" id="saldo34" oninput="formatNumber(this); calculateTotal();" ></th>
              </tr>
            ...
            <option value="<?= $kode_akun ?>" data-bank18="<?= $akun ?>" data-saldo-normal18="<?= $saldo_normal18 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo35" id="saldo35" oninput="formatNumber(this); calculateTotal();" ></th>
              <th><input style="text-align:center" type="text" class="form-control" name="saldo36" id="saldo36" oninput="formatNumber(this); calculateTotal();" ></th>
              </tr>
            ...
            <option value="<?= $kode_akun ?>" data-bank19="<?= $akun ?>" data-saldo-normal19="<?= $saldo_normal19 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo37" id="saldo37" oninput="formatNumber(this); calculateTotal();" ></th>
              <th><input style="text-align:center" type="text" class="form-control" name="saldo38" id="saldo38" oninput="formatNumber(this); calculateTotal();" ></th>
              </tr>
            ...
            <option value="<?= $kode_akun ?>" data-bank20="<?= $akun ?>" data-saldo-normal20="<?= $saldo_normal20 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo39" id="saldo39" oninput="formatNumber(this); calculateTotal();" ></th>
              <th><input style="text-align:center" type="text" class="form-control" name="saldo40" id="saldo40" oninput="formatNumber(this); calculateTotal();" ></th>
              </tr>
            ...
            <option value="<?= $kode_akun ?>" data-bank21="<?= $akun ?>" data-saldo-normal21="<?= $saldo_normal21 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo41" id="saldo41" oninput="formatNumber(this); calculateTotal();" ></th>
              <th><input style="text-align:center" type="text" class="form-control" name="saldo42" id="saldo42" oninput="formatNumber(this); calculateTotal();" ></th>
              </tr>
            ...
            <option value="<?= $kode_akun ?>" data-bank22="<?= $akun ?>" data-saldo-normal22="<?= $saldo_normal22 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo43" id="saldo43" oninput="formatNumber(this); calculateTotal();" ></th>
              <th><input style="text-align:center" type="text" class="form-control" name="saldo44" id="saldo44" oninput="formatNumber(this); calculateTotal();" ></th>
              </tr>
            ...
            <option value="<?= $kode_akun ?>" data-bank23="<?= $akun ?>" data-saldo-normal23="<?= $saldo_normal23 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo45" id="saldo45" oninput="formatNumber(this); calculateTotal();" ></th>
              <th><input style="text-align:center" type="text" class="form-control" name="saldo46" id="saldo46" oninput="formatNumber(this); calculateTotal();" ></th>
              </tr>
            ...
            <option value="<?= $kode_akun ?>" data-bank24="<?= $akun ?>" data-saldo-normal24="<?= $saldo_normal24 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo47" id="saldo47" oninput="formatNumber(this); calculateTotal();" ></th>
              <th><input style="text-align:center" type="text" class="form-control" name="saldo48" id="saldo48" oninput="formatNumber(this); calculateTotal();" ></th>
              </tr>
            ...
            <option value="<?= $kode_akun ?>" data-bank25="<?= $akun ?>" data-saldo-normal25="<?= $saldo_normal25 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo49" id="saldo49" oninput="formatNumber(this); calculateTotal();" ></th>
              <th><input style="text-align:center" type="text" class="form-control" name="saldo50" id="saldo50" oninput="formatNumber(this); calculateTotal();" ></th>
              </tr>
              ...
              <script>
                ...
                function calculateTotal() {
                    ...
                    var saldo26 = parseFloat(document.getElementById('saldo26').value.replace(/,/g, '')) || 0;
                    var saldo27 = parseFloat(document.getElementById('saldo27').value.replace(/,/g, '')) || 0;
                    var saldo28 = parseFloat(document.getElementById('saldo28').value.replace(/,/g, '')) || 0;
                    var saldo29 = parseFloat(document.getElementById('saldo29').value.replace(/,/g, '')) || 0;
                    var saldo30 = parseFloat(document.getElementById('saldo30').value.replace(/,/g, '')) || 0;
                    var saldo31 = parseFloat(document.getElementById('saldo31').value.replace(/,/g, '')) || 0;
                    var saldo32 = parseFloat(document.getElementById('saldo32').value.replace(/,/g, '')) || 0;
                    var saldo33 = parseFloat(document.getElementById('saldo33').value.replace(/,/g, '')) || 0;
                    var saldo34 = parseFloat(document.getElementById('saldo34').value.replace(/,/g, '')) || 0;
                    var saldo35 = parseFloat(document.getElementById('saldo35').value.replace(/,/g, '')) || 0;
                    var saldo36 = parseFloat(document.getElementById('saldo36').value.replace(/,/g, '')) || 0;
                    var saldo37 = parseFloat(document.getElementById('saldo37').value.replace(/,/g, '')) || 0;
                    var saldo38 = parseFloat(document.getElementById('saldo38').value.replace(/,/g, '')) || 0;
                    var saldo39 = parseFloat(document.getElementById('saldo39').value.replace(/,/g, '')) || 0;
                    var saldo40 = parseFloat(document.getElementById('saldo40').value.replace(/,/g, '')) || 0;
                    var saldo41 = parseFloat(document.getElementById('saldo41').value.replace(/,/g, '')) || 0;
                    var saldo42 = parseFloat(document.getElementById('saldo42').value.replace(/,/g, '')) || 0;
                    var saldo43 = parseFloat(document.getElementById('saldo43').value.replace(/,/g, '')) || 0;
                    var saldo44 = parseFloat(document.getElementById('saldo44').value.replace(/,/g, '')) || 0;
                    var saldo45 = parseFloat(document.getElementById('saldo45').value.replace(/,/g, '')) || 0;
                    var saldo46 = parseFloat(document.getElementById('saldo46').value.replace(/,/g, '')) || 0;
                    var saldo47 = parseFloat(document.getElementById('saldo47').value.replace(/,/g, '')) || 0;
                    var saldo48 = parseFloat(document.getElementById('saldo48').value.replace(/,/g, '')) || 0;
                    var saldo49 = parseFloat(document.getElementById('saldo49').value.replace(/,/g, '')) || 0;
                    var saldo50 = parseFloat(document.getElementById('saldo50').value.replace(/,/g, '')) || 0;

                    var total = saldo1 + saldo3 + saldo5 + saldo7 + saldo9 + saldo11 + saldo13 + saldo15 + saldo17 + saldo19 + saldo21 + saldo23 + saldo25 + saldo27 + saldo29 + saldo31 + saldo33 + saldo35 + saldo37 + saldo39 + saldo41 + saldo43 + saldo45 + saldo47 + saldo49;
                    var total2 = saldo2 + saldo4 + saldo6 + saldo8 + saldo10 + saldo12 + saldo14 + saldo16 + saldo18 + saldo20 + saldo22 + saldo24 + saldo26 + saldo28 + saldo30 + saldo32 + saldo34 + saldo36 + saldo38 + saldo40 + saldo42 + saldo44 + saldo46 + saldo48 + saldo50;
                ...
                //     // Get the values of total and total2
                //     var totalValue = parseFloat(document.getElementById('total').value.replace(/[^0-9.]/g, '')) || 0;
                //     var total2Value = parseFloat(document.getElementById('total2').value.replace(/[^0-9.]/g, '')) || 0;

                //     // Compare total and total2
                //     if (totalValue === total2Value) {
                //         // Totals are equal, submit the form
                //         document.getElementById('yourFormId').submit();
                //     } else {
                //         // Totals are not equal, show an alert or perform other actions
                //         alert("Nominal yang dimasukkan tidak seimbang.");
                //     }
                // }validateAndSubmit();
                ...
                function removeFormatFromSaldoInputs() {
                    ...
                    removeFormat(document.getElementById('saldo26'));
                    removeFormat(document.getElementById('saldo27'));
                    removeFormat(document.getElementById('saldo28'));
                    removeFormat(document.getElementById('saldo29'));
                    removeFormat(document.getElementById('saldo30'));
                    removeFormat(document.getElementById('saldo31'));
                    removeFormat(document.getElementById('saldo32'));
                    removeFormat(document.getElementById('saldo33'));
                    removeFormat(document.getElementById('saldo34'));
                    removeFormat(document.getElementById('saldo35'));
                    removeFormat(document.getElementById('saldo36'));
                    removeFormat(document.getElementById('saldo37'));
                    removeFormat(document.getElementById('saldo38'));
                    removeFormat(document.getElementById('saldo39'));
                    removeFormat(document.getElementById('saldo40'));
                    removeFormat(document.getElementById('saldo41'));
                    removeFormat(document.getElementById('saldo42'));
                    removeFormat(document.getElementById('saldo43'));
                    removeFormat(document.getElementById('saldo44'));
                    removeFormat(document.getElementById('saldo45'));
                    removeFormat(document.getElementById('saldo46'));
                    removeFormat(document.getElementById('saldo47'));
                    removeFormat(document.getElementById('saldo48'));
                    removeFormat(document.getElementById('saldo49'));
                    removeFormat(document.getElementById('saldo50'));
                }
                </script>
                  <div class="card-body">
...
if (isset($_POST['simpan'])) {
  ...
  $saldo26 = $_POST['saldo26'];
  $saldo27 = $_POST['saldo27'];
  $saldo28 = $_POST['saldo28'];
  $saldo29 = $_POST['saldo29'];
  $saldo30 = $_POST['saldo30'];
  $saldo31 = $_POST['saldo31'];
  $saldo32 = $_POST['saldo32'];
  $saldo33 = $_POST['saldo33'];
  $saldo34 = $_POST['saldo34'];
  $saldo35 = $_POST['saldo35'];
  $saldo36 = $_POST['saldo36'];
  $saldo37 = $_POST['saldo37'];
  $saldo38 = $_POST['saldo38'];
  $saldo39 = $_POST['saldo39'];
  $saldo40 = $_POST['saldo40'];
  $saldo41 = $_POST['saldo41'];
  $saldo42 = $_POST['saldo42'];
  $saldo43 = $_POST['saldo43'];
  $saldo44 = $_POST['saldo44'];
  $saldo45 = $_POST['saldo45'];
  $saldo46 = $_POST['saldo46'];
  $saldo47 = $_POST['saldo47'];
  $saldo48 = $_POST['saldo48'];
  $saldo49 = $_POST['saldo49'];
  $saldo50 = $_POST['saldo50'];
    ...
    $data_akun17 = $result_akun17->fetch_assoc();
    ...
    if((isset($_POST['simpan']))){
      ...
      $insertquery = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana, no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
      VALUES('$status','$tanggal','$sumber_dana','$no_transaksi','$kode_jenjang1','$nama_jenjang1','$kode_tahun','$tahun_ajaran','$keterangan1','$kode_akun','$nama_akun','$saldo1','$saldo2')";
      
      $insertquery2 = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana, no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
      VALUES('$status','$tanggal','','$no_transaksi','$kode_jenjang2','$nama_jenjang2','$kode_tahun','$tahun_ajaran','$keterangan2','$kode_akun2','$nama_akun2','$saldo3','$saldo4')";
      ...
      $insertquery3 = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana,	no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
      VALUES('$status','$tanggal','','$no_transaksi','$kode_jenjang3','$nama_jenjang3','$kode_tahun','$tahun_ajaran','$keterangan3','$kode_akun3','$nama_akun3','$saldo5','$saldo6')";
      ...
      $insertquery4 = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana,	no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
      VALUES('$status','$tanggal','','$no_transaksi','$kode_jenjang4','$nama_jenjang4','$kode_tahun','$tahun_ajaran','$keterangan4','$kode_akun4','$nama_akun4','$saldo7','$saldo8')";
      ...
      $insertquery5 = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana,	no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
      VALUES('$status','$tanggal','','$no_transaksi','$kode_jenjang5','$nama_jenjang5','$kode_tahun','$tahun_ajaran','$keterangan5','$kode_akun5','$nama_akun5','$saldo9','$saldo10')";
      ...
      $insertquery6 = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana,	no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
      VALUES('$status','$tanggal','','$no_transaksi','$kode_jenjang6','$nama_jenjang6','$kode_tahun','$tahun_ajaran','$keterangan6','$kode_akun6','$nama_akun6','$saldo11','$saldo12')";
      ...
      $insertquery7 = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana,	no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
      VALUES('$status','$tanggal','','$no_transaksi','$kode_jenjang7','$nama_jenjang7','$kode_tahun','$tahun_ajaran','$keterangan7','$kode_akun7','$nama_akun7','$saldo13','$saldo14')";
    ...
    $insertquery8 = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana,	no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
    VALUES('$status','$tanggal','','$no_transaksi','$kode_jenjang8','$nama_jenjang8','$kode_tahun','$tahun_ajaran','$keterangan8','$kode_akun8','$nama_akun8','$saldo15','$saldo16')";
    ...
    $insertquery9 = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana,	no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
    VALUES('$status','$tanggal','','$no_transaksi','$kode_jenjang9','$nama_jenjang9','$kode_tahun','$tahun_ajaran','$keterangan9','$kode_akun9','$nama_akun9','$saldo17','$saldo18')";

  }if (!empty($kode_akun10)){
    $insertquery = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana, no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
    VALUES('$status','$tanggal','$sumber_dana','$no_transaksi','$kode_jenjang1','$nama_jenjang1','$kode_tahun','$tahun_ajaran','$keterangan1','$kode_akun','$nama_akun','$saldo1','$saldo2')";
    ...
    $insertquery10 = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana,	no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
    VALUES('$status','$tanggal','','$no_transaksi','$kode_jenjang10','$nama_jenjang10','$kode_tahun','$tahun_ajaran','$keterangan10','$kode_akun10','$nama_akun10','$saldo19','$saldo20')";

  }if (!empty($kode_akun11)){
    $insertquery = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana, no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
    VALUES('$status','$tanggal','$sumber_dana','$no_transaksi','$kode_jenjang1','$nama_jenjang1','$kode_tahun','$tahun_ajaran','$keterangan1','$kode_akun','$nama_akun','$saldo1','$saldo2')";
    ...
    $insertquery11 = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana,	no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
    VALUES('$status','$tanggal','','$no_transaksi','$kode_jenjang11','$nama_jenjang11','$kode_tahun','$tahun_ajaran','$keterangan11','$kode_akun11','$nama_akun11','$saldo21','$saldo22')";

  }if (!empty($kode_akun12)){
    $insertquery = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana, no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
    VALUES('$status','$tanggal','$sumber_dana','$no_transaksi','$kode_jenjang1','$nama_jenjang1','$kode_tahun','$tahun_ajaran','$keterangan1','$kode_akun','$nama_akun','$saldo1','$saldo2')";
    ...
    $insertquery12 = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana,	no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
    VALUES('$status','$tanggal','','$no_transaksi','$kode_jenjang12','$nama_jenjang12','$kode_tahun','$tahun_ajaran','$keterangan12','$kode_akun12','$nama_akun12','$saldo23','$saldo24')";

  }if (!empty($kode_akun13)){
    $insertquery = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana, no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
    VALUES('$status','$tanggal','$sumber_dana','$no_transaksi','$kode_jenjang1','$nama_jenjang1','$kode_tahun','$tahun_ajaran','$keterangan1','$kode_akun','$nama_akun','$saldo1','$saldo2')";
    ...
    $insertquery13 = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana,	no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
    VALUES('$status','$tanggal','','$no_transaksi','$kode_jenjang13','$nama_jenjang13','$kode_tahun','$tahun_ajaran','$keterangan13','$kode_akun13','$nama_akun13','$saldo25','$saldo26')";


  }if (!empty($kode_akun14)){
    $insertquery = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana, no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
    VALUES('$status','$tanggal','$sumber_dana','$no_transaksi','$kode_jenjang1','$nama_jenjang1','$kode_tahun','$tahun_ajaran','$keterangan1','$kode_akun','$nama_akun','$saldo1','$saldo2')";
    ...
    $insertquery14 = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana,	no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
    VALUES('$status','$tanggal','','$no_transaksi','$kode_jenjang14','$nama_jenjang14','$kode_tahun','$tahun_ajaran','$keterangan14','$kode_akun14','$nama_akun14','$saldo27','$saldo28')";


  }if (!empty($kode_akun15)){
    $insertquery = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana, no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
    VALUES('$status','$tanggal','$sumber_dana','$no_transaksi','$kode_jenjang1','$nama_jenjang1','$kode_tahun','$tahun_ajaran','$keterangan1','$kode_akun','$nama_akun','$saldo1','$saldo2')";
    ...
    $insertquery15 = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana,	no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
    VALUES('$status','$tanggal','','$no_transaksi','$kode_jenjang15','$nama_jenjang15','$kode_tahun','$tahun_ajaran','$keterangan15','$kode_akun15','$nama_akun15','$saldo29','$saldo30')";
    
  }if (!empty($kode_akun16)){
    $insertquery = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana, no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
    VALUES('$status','$tanggal','$sumber_dana','$no_transaksi','$kode_jenjang1','$nama_jenjang1','$kode_tahun','$tahun_ajaran','$keterangan1','$kode_akun','$nama_akun','$saldo1','$saldo2')";
    ...
    $insertquery16 = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana,	no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
    VALUES('$status','$tanggal','','$no_transaksi','$kode_jenjang16','$nama_jenjang16','$kode_tahun','$tahun_ajaran','$keterangan16','$kode_akun16','$nama_akun16','$saldo31','$saldo32')";

}if (!empty($kode_akun17)){
  $insertquery = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana, no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
  VALUES('$status','$tanggal','$sumber_dana','$no_transaksi','$kode_jenjang1','$nama_jenjang1','$kode_tahun','$tahun_ajaran','$keterangan1','$kode_akun','$nama_akun','$saldo1','$saldo2')";
  ...
  $insertquery17 = "INSERT INTO transaksi_memorial (status, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit) 
  VALUES('$status','$tanggal','','$no_transaksi','$kode_jenjang17','$nama_jenjang17','$kode_tahun','$tahun_ajaran','$keterangan17','$kode_akun17','$nama_akun17','$saldo33','$saldo34')";


}if (!empty($kode_akun18)){
  $insertquery = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana, no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
  VALUES('$status','$tanggal','$sumber_dana','$no_transaksi','$kode_jenjang1','$nama_jenjang1','$kode_tahun','$tahun_ajaran','$keterangan1','$kode_akun','$nama_akun','$saldo1','$saldo2')";
  ...
  $insertquery18 = "INSERT INTO transaksi_memorial (status, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit) 
  VALUES('$status','$tanggal','','$no_transaksi','$kode_jenjang18','$nama_jenjang18','$kode_tahun','$tahun_ajaran','$keterangan18','$kode_akun18','$nama_akun18','$saldo35','$saldo36')";


}if (!empty($kode_akun19)){
  $insertquery = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana, no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
  VALUES('$status','$tanggal','$sumber_dana','$no_transaksi','$kode_jenjang1','$nama_jenjang1','$kode_tahun','$tahun_ajaran','$keterangan1','$kode_akun','$nama_akun','$saldo1','$saldo2')";
  ...
  $insertquery19 = "INSERT INTO transaksi_memorial (status, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit) 
  VALUES('$status','$tanggal','','$no_transaksi','$kode_jenjang19','$nama_jenjang19','$kode_tahun','$tahun_ajaran','$keterangan19','$kode_akun19','$nama_akun19','$saldo37','$saldo38')";


}if (!empty($kode_akun20)){
  $insertquery = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana, no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
  VALUES('$status','$tanggal','$sumber_dana','$no_transaksi','$kode_jenjang1','$nama_jenjang1','$kode_tahun','$tahun_ajaran','$keterangan1','$kode_akun','$nama_akun','$saldo1','$saldo2')";
  ...
  $insertquery20 = "INSERT INTO transaksi_memorial (status, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit) 
  VALUES('$status','$tanggal','','$no_transaksi','$kode_jenjang20','$nama_jenjang20','$kode_tahun','$tahun_ajaran','$keterangan20','$kode_akun20','$nama_akun20','$saldo39','$saldo40')";

}if (!empty($kode_akun21)){
  $insertquery = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana, no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
  VALUES('$status','$tanggal','$sumber_dana','$no_transaksi','$kode_jenjang1','$nama_jenjang1','$kode_tahun','$tahun_ajaran','$keterangan1','$kode_akun','$nama_akun','$saldo1','$saldo2')";
  ...
  $insertquery21 = "INSERT INTO transaksi_memorial (status, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit) 
  VALUES('$status','$tanggal','','$no_transaksi','$kode_jenjang21','$nama_jenjang21','$kode_tahun','$tahun_ajaran','$keterangan21','$kode_akun21','$nama_akun21','$saldo41','$saldo42')";

}if (!empty($kode_akun22)){
  $insertquery = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana, no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
  VALUES('$status','$tanggal','$sumber_dana','$no_transaksi','$kode_jenjang1','$nama_jenjang1','$kode_tahun','$tahun_ajaran','$keterangan1','$kode_akun','$nama_akun','$saldo1','$saldo2')";
  ...
  $insertquery22 = "INSERT INTO transaksi_memorial (status, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit) 
  VALUES('$status','$tanggal','','$no_transaksi','$kode_jenjang22','$nama_jenjang22','$kode_tahun','$tahun_ajaran','$keterangan22','$kode_akun22','$nama_akun22','$saldo43','$saldo44')";

}if (!empty($kode_akun23)){
  $insertquery = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana, no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
  VALUES('$status','$tanggal','$sumber_dana','$no_transaksi','$kode_jenjang1','$nama_jenjang1','$kode_tahun','$tahun_ajaran','$keterangan1','$kode_akun','$nama_akun','$saldo1','$saldo2')";
  ...
  $insertquery23 = "INSERT INTO transaksi_memorial (status, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit) 
  VALUES('$status','$tanggal','','$no_transaksi','$kode_jenjang23','$nama_jenjang23','$kode_tahun','$tahun_ajaran','$keterangan23','$kode_akun23','$nama_akun23','$saldo45','$saldo46')";

}if (!empty($kode_akun24)){
  $insertquery = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana, no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
  VALUES('$status','$tanggal','$sumber_dana','$no_transaksi','$kode_jenjang1','$nama_jenjang1','$kode_tahun','$tahun_ajaran','$keterangan1','$kode_akun','$nama_akun','$saldo1','$saldo2')";
  ...
  $insertquery24 = "INSERT INTO transaksi_memorial (status, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit) 
  VALUES('$status','$tanggal','','$no_transaksi','$kode_jenjang24','$nama_jenjang24','$kode_tahun','$tahun_ajaran','$keterangan24','$kode_akun24','$nama_akun24','$saldo47','$saldo48')";

}if (!empty($kode_akun25)){
  $insertquery = "INSERT INTO transaksi_memorial (status, tanggal,	sumber_dana, no_transaksi,	kode_jenjang,	nama_jenjang,	kode_tahun,	tahun_ajaran,	keterangan,	kode_akun,	nama_akun,	debit, kredit) 
  VALUES('$status','$tanggal','$sumber_dana','$no_transaksi','$kode_jenjang1','$nama_jenjang1','$kode_tahun','$tahun_ajaran','$keterangan1','$kode_akun','$nama_akun','$saldo1','$saldo2')";
  ...
  $insertquery25 = "INSERT INTO transaksi_memorial (status, tanggal, sumber_dana, no_transaksi, kode_jenjang, nama_jenjang, kode_tahun, tahun_ajaran, keterangan, kode_akun, nama_akun, debit, kredit) 
  VALUES('$status','$tanggal','','$no_transaksi','$kode_jenjang25','$nama_jenjang25','$kode_tahun','$tahun_ajaran','$keterangan25','$kode_akun25','$nama_akun25','$saldo49','$saldo50')";
}}
?>
