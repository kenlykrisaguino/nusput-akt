...
<body class="bg-light">
    <div class="container mt-4">
        ...
        <h3 class="text-muted">Selamat Datang di Sistem Akuntansi Nusaputera</h3>
        ...
        <div class="row mt-4" id="card-container">
            ...
            <div class="col-xl-3 col-md-6 mb-4 card-item master semua">
                <div class="card dashboard-card shadow-sm border-left-success p-3">
                    <a href="?page=th_ajaran" class="text-decoration-none text-dark">
                        <div class="card-body text-center">
                            <i class="fas fa-calendar-alt card-icon text-success"></i>
            ...
            <div class="col-xl-3 col-md-6 mb-4 card-item master semua">
                <div class="card dashboard-card shadow-sm border-left-secondary p-3">
                    <a href="?page=master_transaksi" class="text-decoration-none text-dark">
                        <div class="card-body text-center">
                            <i class="fas fa-exchange-alt card-icon text-secondary"></i>
                            <h5 class="mt-3">Data Master Jurnal</h5>
                        </div>
                    </a>
                </div>
            </div>
            ...
            <!-- <div class="col-xl-3 col-md-6 mb-4 card-item master aset semua">
                <div class="card dashboard-card shadow-sm border-left-danger p-3">
                    <a href="?page=lokasi" class="text-decoration-none text-dark">
                        <div class="card-body text-center">
                            <i class="fas fa-map-marked-alt card-icon text-danger"></i>
                            <h5 class="mt-3">Master Data Lokasi</h5>
                        </div>
                    </a>
                </div>
            </div>
                ...
                <div class="card dashboard-card shadow-sm border-left-info p-3">
                    <a href="?page=kegiatan" class="text-decoration-none text-dark">
                        <div class="card-body text-center">
                            ...
                            <h5 class="mt-3">Master Data Kegiatan</h5>
                        </div>
                    </a>
                </div>
            </div> -->
          ...
          <!-- Transaksi -->
            ...
            <div class="col-xl-3 col-md-6 mb-4 card-item transaksi semua">
                <div class="card dashboard-card shadow-sm border-left-warning p-3">
                    <a href="?page=transaksi_memorial&aksi=data" class="text-decoration-none text-dark">
                        <div class="card-body text-center">
                            <i class="fas fa-file-alt card-icon text-warning"></i>
                            <h5 class="mt-3">Pejurnalan Memorial</h5>
                        </div>
                    </a>
                </div>
            </div>
            ...
            <!-- <div class="col-xl-3 col-md-6 mb-4 card-item transaksi semua">
                <div class="card dashboard-card shadow-sm border-left-danger p-3">
                    <a href="?page=transaksi_kas" class="text-decoration-none text-dark">
                        <div class="card-body text-center">
                            <i class="fas fa-wallet card-icon text-danger"></i>
            ...
            <div class="col-xl-3 col-md-6 mb-4 card-item transaksi semua">
                <div class="card dashboard-card shadow-sm border-left-info p-3">
                    <a href="?page=transaksi&aksi=data" class="text-decoration-none text-dark">
                        <div class="card-body text-center">
                            <i class="fas fa-random card-icon text-info"></i>
                            <h5 class="mt-3">Transaksi Keuangan</h5>
                        </div>
                    </a>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4 card-item laporan semua">
                <div class="card dashboard-card shadow-sm border-left-primary p-3">
                    <a href="?page=labarugi" class="text-decoration-none text-dark">
                        <div class="card-body text-center">
                            <i class="fas fa-chart-pie card-icon text-primary"></i>
                            <h5 class="mt-3">Laporan Laba Rugi</h5>
                        </div>
                    </a>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4 card-item laporan semua">
                <div class="card dashboard-card shadow-sm border-left-secondary p-3">
                    <a href="?page=neraca" class="text-decoration-none text-dark">
                        <div class="card-body text-center">
                            <i class="fas fa-balance-scale-left card-icon text-secondary"></i>
                            <h5 class="mt-3">Laporan Posisi Keuangan</h5>
                        </div>
                    </a>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4 card-item laporan semua">
                <div class="card dashboard-card shadow-sm border-left-dark p-3">
                    <a href="?page=buku_besar" class="text-decoration-none text-dark">
                        <div class="card-body text-center">
                            <i class="fas fa-book-open card-icon text-dark"></i>
            ...
            <div class="col-xl-3 col-md-6 mb-4 card-item laporan semua">
                <div class="card dashboard-card shadow-sm border-left-warning p-3">
                    <a href="?page=neracasaldo" class="text-decoration-none text-dark">
                        <div class="card-body text-center">
