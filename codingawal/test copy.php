    ...
    <input type="hidden" name="no_transaksi" id="no_transaksi" value="<?= $kode_transaksi ?>" class="form-control col-sm-9">
        ...
        <hr>
            ...
            <option value="<?= $kode_akun ?>" data-bank3="<?= $akun ?>" data-saldo-normal3="<?= $saldo_normal3 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo3" id="saldo3" value="0" oninput="formatNumber(this); calculateTotal();" ></th>
            ...
            <option value="<?= $kode_akun ?>" data-bank4="<?= $akun ?>" data-saldo-normal4="<?= $saldo_normal4 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo4" id="saldo4" value="0" oninput="formatNumber(this); calculateTotal();" ></th>
            ...
            <option value="<?= $kode_akun ?>" data-bank5="<?= $akun ?>" data-saldo-normal5="<?= $saldo_normal5 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo5" id="saldo5" value="0" oninput="formatNumber(this); calculateTotal();" ></th>
            ...
            <option value="<?= $kode_akun ?>" data-bank6="<?= $akun ?>" data-saldo-normal6="<?= $saldo_normal6 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo6" id="saldo6" value="0" oninput="formatNumber(this); calculateTotal();" ></th>
            ...
            <option value="<?= $kode_akun ?>" data-bank7="<?= $akun ?>" data-saldo-normal7="<?= $saldo_normal7 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo7" id="saldo7" value="0" oninput="formatNumber(this); calculateTotal();" ></th>
            ...
            <option value="<?= $kode_akun ?>" data-bank8="<?= $akun ?>" data-saldo-normal8="<?= $saldo_normal8 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo8" id="saldo8" value="0" oninput="formatNumber(this); calculateTotal();" ></th>
            ...
            <option value="<?= $kode_akun ?>" data-bank9="<?= $akun ?>" data-saldo-normal9="<?= $saldo_normal9 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo9" id="saldo9" value="0" oninput="formatNumber(this); calculateTotal();" ></th>
            ...
            <option value="<?= $kode_akun ?>" data-bank10="<?= $akun ?>" data-saldo-normal10="<?= $saldo_normal10 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo10" id="saldo10" value="0" oninput="formatNumber(this); calculateTotal();" ></th>
            ...
            <option value="<?= $kode_akun ?>" data-bank11="<?= $akun ?>" data-saldo-normal11="<?= $saldo_normal11 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo11" id="saldo11" value="0" oninput="formatNumber(this); calculateTotal();" ></th>
            ...
            <option value="<?= $kode_akun ?>" data-bank12="<?= $akun ?>" data-saldo-normal12="<?= $saldo_normal12 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo12" id="saldo12" value="0" oninput="formatNumber(this); calculateTotal();" ></th>
            ...
            <option value="<?= $kode_akun ?>" data-bank13="<?= $akun ?>" data-saldo-normal13="<?= $saldo_normal13 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo13" id="saldo13" value="0" oninput="formatNumber(this); calculateTotal();" ></th>
            ...
            <option value="<?= $kode_akun ?>" data-bank14="<?= $akun ?>" data-saldo-normal14="<?= $saldo_normal14 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo14" id="saldo14" value="0" oninput="formatNumber(this); calculateTotal();" ></th>
            ...
            <option value="<?= $kode_akun ?>" data-bank15="<?= $akun ?>" data-saldo-normal15="<?= $saldo_normal15 ?>"><?= $kode_akun . ' → ' . $akun ?></option>
              ...
              <th><input style="text-align:center" type="text" class="form-control" name="saldo15" id="saldo15" value="0" oninput="formatNumber(this); calculateTotal();" ></th>
