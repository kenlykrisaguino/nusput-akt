...
?>
    ...
    <div class="form-group row">
        <label for="nama" class="col-sm-2"><b>Akun Bank</b></label>
          <select name="akun_bank" id="akun_bank" class="form-control col-sm-9" required>
...
if (isset($_POST['simpan'])) {
    ...
    $query_akun = "SELECT nama_akun FROM akun WHERE kode_akun='$akun_bank'";
    ...
    if ($jenis_transaksi === 'Penerimaan' && !empty($kode_akun)) {
      $insertquery1 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, debit)
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','$kode_tahun','$tahun_ajaran','','','$sumber_dana','','$akun_kas','$nama','$total')";

      $insertquery2 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, debit, kode_akun, nama_akun, kredit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang1','$nama_jenjang1','','$keterangan1','','','','$kode_akun','$nama_akun','$saldo1')";  
    
    } if ($jenis_transaksi === 'Pengeluaran' && !empty($kode_akun)) {
      $insertquery1 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, kredit)
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','$kode_tahun','$tahun_ajaran','','','$sumber_dana','','$akun_kas','$nama','$total')";

      $insertquery2 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang1','$nama_jenjang1','','$keterangan1','','','','$kode_akun','$nama_akun','$saldo1')";  
      ...
      $insertquery3 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, debit, kode_akun, nama_akun, kredit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang2','$nama_jenjang2','','$keterangan2','','','','$kode_akun','$nama_akun','$saldo2')";  
      ...
      $insertquery3 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang2','$nama_jenjang2','','$keterangan2','','','','$kode_akun','$nama_akun','$saldo2')"; 
      ...
      $insertquery4 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, debit, kode_akun, nama_akun, kredit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang3','$nama_jenjang3','','$keterangan3','','','','$kode_akun','$nama_akun','$saldo3')";
      ...
      $insertquery4 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang3','$nama_jenjang3','','$keterangan3','','','','$kode_akun','$nama_akun','$saldo3')";
      ...
      $insertquery5 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, debit, kode_akun, nama_akun, kredit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang4','$nama_jenjang4','','$keterangan4','','','','$kode_akun','$nama_akun','$saldo4')";          
      ...
      $insertquery5 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang4','$nama_jenjang4','','$keterangan4','','','','$kode_akun','$nama_akun','$saldo4')";
      ...
      $insertquery6 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, debit, kode_akun, nama_akun, kredit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang5','$nama_jenjang5','','$keterangan5','','','','$kode_akun','$nama_akun','$saldo5')";
      ...
      $insertquery6 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang5','$nama_jenjang5','','$keterangan5','','','','$kode_akun','$nama_akun','$saldo5')";
      ...
      $insertquery7 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, debit, kode_akun, nama_akun, kredit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang6','$nama_jenjang6','','$keterangan6','','','','$kode_akun','$nama_akun','$saldo6')";
      ...
      $insertquery7  = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang6','$nama_jenjang6','','$keterangan6','','','','$kode_akun','$nama_akun','$saldo6')";
      ...
      $insertquery8 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, debit, kode_akun, nama_akun, kredit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang7','$nama_jenjang7','','$keterangan7','','','','$kode_akun','$nama_akun','$saldo7')";
      ...
      $insertquery8 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang7','$nama_jenjang7','','$keterangan7','','','','$kode_akun','$nama_akun','$saldo7')";
      ...
      $insertquery9 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, debit, kode_akun, nama_akun, kredit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang8','$nama_jenjang8','','$keterangan8','','','','$kode_akun','$nama_akun','$saldo8')";
      ...
      $insertquery9 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang8','$nama_jenjang8','','$keterangan8','','','','$kode_akun','$nama_akun','$saldo8')";
      ...
      $insertquery10 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, debit, kode_akun, nama_akun, kredit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang9','$nama_jenjang9','','$keterangan9','','','','$kode_akun','$nama_akun','$saldo9')";
      ...
      $insertquery10 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang9','$nama_jenjang9','','$keterangan9','','','','$kode_akun','$nama_akun','$saldo9')";
      ...
      $insertquery11 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, debit, kode_akun, nama_akun, kredit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang10','$nama_jenjang10','','$keterangan10','','','','$kode_akun','$nama_akun','$saldo10')";
      ...
      $insertquery11 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang9','$nama_jenjang10','','$keterangan10','','','','$kode_akun','$nama_akun','$saldo10')";
      ...
      $insertquery12 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, debit, kode_akun, nama_akun, kredit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang11','$nama_jenjang11','','$keterangan11','','','','$kode_akun','$nama_akun','$saldo11')";
      ...
      $insertquery12 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang11','$nama_jenjang11','','$keterangan11','','','','$kode_akun','$nama_akun','$saldo11')";
      ...
      $insertquery13 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, debit, kode_akun, nama_akun, kredit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang12','$nama_jenjang12','','$keterangan12','','','','$kode_akun','$nama_akun','$saldo12')";
      ...
      $insertquery13 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang12','$nama_jenjang12','','$keterangan12','','','','$kode_akun','$nama_akun','$saldo12')";
      ...
      $insertquery14 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, debit, kode_akun, nama_akun, kredit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang13','$nama_jenjang13','','$keterangan13','','','','$kode_akun','$nama_akun','$saldo13')";
      ...
      $insertquery14 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang13','$nama_jenjang13','','$keterangan13','','','','$kode_akun','$nama_akun','$saldo13')";
      ...
      $insertquery15 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, debit, kode_akun, nama_akun, kredit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang14','$nama_jenjang14','','$keterangan14','','','','$kode_akun','$nama_akun','$saldo14')";
      ...
      $insertquery15 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang14','$nama_jenjang14','','$keterangan14','','','','$kode_akun','$nama_akun','$saldo14')";
      ...
      $insertquery16 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, debit, kode_akun, nama_akun, kredit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang15','$nama_jenjang15','','$keterangan15','','','','$kode_akun','$nama_akun','$saldo15')";
      ...
      $insertquery16 = "INSERT INTO transaksi_bank (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_bank, nama_bank, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang15','$nama_jenjang15','','$keterangan15','','','','$kode_akun','$nama_akun','$saldo15')";
