...
if (isset($_POST['simpan'])) {
    ...
    if ($jenis_transaksi === 'Penerimaan' && !empty($kode_akun)) {
      $insertquery1 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, kredit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun','$nama_akun','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang1','$nama_jenjang1','$keterangan1','$total','$saldo1','$status')";
        ...
        $insertquery1 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, kredit, status) 
        VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun','$nama_akun','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang1','$nama_jenjang1','$keterangan1','$saldo1','$total','$status')";
      ...
      $insertquery2 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun2','$nama_akun2','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang2','$nama_jenjang2','$keterangan2','$saldo2','$status')";  

    } if ($jenis_transaksi === 'Pengeluaran' && !empty($kode_akun2)) {
      $insertquery1 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, kredit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun','$nama_akun','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang1','$nama_jenjang1','$keterangan1','$saldo1','$total','$status')";

      $insertquery2 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun2','$nama_akun2','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang2','$nama_jenjang2','$keterangan2','$saldo2','$status')";
      ...
      $insertquery3 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun3','$nama_akun3','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang3','$nama_jenjang3','$keterangan3','$saldo3','$status')";  
      ...
      $insertquery3 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun3','$nama_akun3','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang3','$nama_jenjang3','$keterangan3','$saldo3','$status')";
      ...
      $insertquery4 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun4','$nama_akun4','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang4','$nama_jenjang4','$keterangan4','$saldo4','$status')";
      ...
      $insertquery4 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun4','$nama_akun4','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang4','$nama_jenjang4','$keterangan4','$saldo4','$status')";
      ...
      $insertquery5 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun5','$nama_akun5','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang5','$nama_jenjang5','$keterangan5','$saldo5','$status')";
      ...
      $insertquery5 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun5','$nama_akun5','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang5','$nama_jenjang5','$keterangan5','$saldo5','$status')";
      ...
      $insertquery6 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun6','$nama_akun6','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang6','$nama_jenjang6','$keterangan6','$saldo6','$status')";
      ...
      $insertquery6 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun6','$nama_akun6','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang6','$nama_jenjang6','$keterangan6','$saldo6','$status')";
      ...
      $insertquery7 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun7','$nama_akun7','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang7','$nama_jenjang7','$keterangan7','$saldo7','$status')";
      ...
      $insertquery7 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun7','$nama_akun7','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang7','$nama_jenjang7','$keterangan7','$saldo7','$status')";
      ...
      $insertquery8 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun8','$nama_akun8','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang8','$nama_jenjang8','$keterangan8','$saldo8','$status')";
      ...
      $insertquery8 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun8','$nama_akun8','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang8','$nama_jenjang8','$keterangan8','$saldo8','$status')";
      ...
      $insertquery9 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun9','$nama_akun9','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang9','$nama_jenjang9','$keterangan9','$saldo9','$status')";
      ...
      $insertquery9 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun9','$nama_akun9','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang9','$nama_jenjang9','$keterangan9','$saldo9','$status')";
      ...
      $insertquery10 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun10','$nama_akun10','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang10','$nama_jenjang10','$keterangan10','$saldo10','$status')";
      ...
      $insertquery10 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun10','$nama_akun10','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang10','$nama_jenjang10','$keterangan10','$saldo10','$status')";
      ...
      $insertquery11 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun11','$nama_akun11','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang11','$nama_jenjang11','$keterangan11','$saldo11','$status')";
      ...
      $insertquery11 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun11','$nama_akun11','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang11','$nama_jenjang11','$keterangan11','$saldo11','$status')";
      ...
      $insertquery12 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun12','$nama_akun12','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang12','$nama_jenjang12','$keterangan12','$saldo12','$status')";
      ...
      $insertquery12 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun12','$nama_akun12','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang12','$nama_jenjang12','$keterangan12','$saldo12','$status')";
      ...
      $insertquery13 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun13','$nama_akun13','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang13','$nama_jenjang13','$keterangan13','$saldo13','$status')";
      ...
      $insertquery13 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun13','$nama_akun13','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang13','$nama_jenjang13','$keterangan13','$saldo13','$status')";
      ...
      $insertquery14 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun14','$nama_akun14','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang14','$nama_jenjang14','$keterangan14','$saldo14','$status')";
      ...
      $insertquery14 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun14','$nama_akun14','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang14','$nama_jenjang14','$keterangan14','$saldo14','$status')";
      ...
      $insertquery15 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun15','$nama_akun15','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang15','$nama_jenjang15','$keterangan15','$saldo15','$status')";
      ...
      $insertquery15 = "INSERT INTO transaksi_kas (no_transaksi, jenis_transaksi, kode_akun, nama_akun, akun_kas, nama, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun15','$nama_akun15','$akun_kas','$nama','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang15','$nama_jenjang15','$keterangan15','$saldo15','$status')";
