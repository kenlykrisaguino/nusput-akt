...
?>
    ...
    <div class="card-body">
      ...
      <a href="?page=transaksi_bank&aksi=pembalikkasbon" class="btn btn-warning">Transaksi pembalik kasbon</a> 
...
if (isset($_POST['simpan'])) {
    ...
    if ($jenis_transaksi === 'Penerimaan' && !empty($kode_akun)) {
      $insertquery1 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, kredit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun','$nama_akun','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang1','$nama_jenjang1','$keterangan1','$total','$saldo1','$status','$no_kasbon')";
    
    } if ($jenis_transaksi === 'Pengeluaran' && !empty($kode_akun)) {
      $insertquery1 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, kredit, status, no_kasbon)
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun','$nama_akun','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang1','$nama_jenjang1','$keterangan1','$saldo1','$total','$status','$no_kasbon')";
      ...
      $insertquery2 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status, no_kasbon)
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun2','$nama_akun2','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang2','$nama_jenjang2','$keterangan2','$saldo2','$status','$no_kasbon')";

    } if ($jenis_transaksi === 'Pengeluaran' && !empty($kode_akun2)) {
      $insertquery1 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, kredit, status, no_kasbon)
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun','$nama_akun','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang1','$nama_jenjang1','$keterangan1','$saldo1','$total','$status','$no_kasbon')";

      $insertquery2 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status, no_kasbon)
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun2','$nama_akun2','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang2','$nama_jenjang2','$keterangan2','$saldo2','$status','$no_kasbon'')";
      ...
      $insertquery3 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun3','$nama_akun3','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang3','$nama_jenjang3','$keterangan3','$saldo3','$status','$no_kasbon')";  
      ...
      $insertquery3 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun3','$nama_akun3','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang3','$nama_jenjang3','$keterangan3','$saldo3','$status','$no_kasbon')";
      ...
      $insertquery4 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun4','$nama_akun4','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang4','$nama_jenjang4','$keterangan4','$saldo4','$status','$no_kasbon')";
      ...
      $insertquery4 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun4','$nama_akun4','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang4','$nama_jenjang4','$keterangan4','$saldo4','$status','$no_kasbon')";
      ...
      $insertquery5 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun5','$nama_akun5','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang5','$nama_jenjang5','$keterangan5','$saldo5','$status','$no_kasbon')";
      ...
      $insertquery5 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun5','$nama_akun5','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang5','$nama_jenjang5','$keterangan5','$saldo5','$status','$no_kasbon')";
      ...
      $insertquery6 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun6','$nama_akun6','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang6','$nama_jenjang6','$keterangan6','$saldo6','$status','$no_kasbon')";
      ...
      $insertquery6 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun6','$nama_akun6','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang6','$nama_jenjang6','$keterangan6','$saldo6','$status','$no_kasbon')";
      ...
      $insertquery7 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun7','$nama_akun7','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang7','$nama_jenjang7','$keterangan7','$saldo7','$status','$no_kasbon')";
      ...
      $insertquery7 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun7','$nama_akun7','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang7','$nama_jenjang7','$keterangan7','$saldo7','$status','$no_kasbon')";
      ...
      $insertquery8 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun8','$nama_akun8','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang8','$nama_jenjang8','$keterangan8','$saldo8','$status','$no_kasbon')";
      ...
      $insertquery8 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun8','$nama_akun8','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang8','$nama_jenjang8','$keterangan8','$saldo8','$status','$no_kasbon')";
      ...
      $insertquery9 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun9','$nama_akun9','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang9','$nama_jenjang9','$keterangan9','$saldo9','$status','$no_kasbon')";
      ...
      $insertquery9 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun9','$nama_akun9','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang9','$nama_jenjang9','$keterangan9','$saldo9','$status','$no_kasbon')";
      ...
      $insertquery10 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun10','$nama_akun10','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang10','$nama_jenjang10','$keterangan10','$saldo10','$status','$no_kasbon')";
      ...
      $insertquery10 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun10','$nama_akun10','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang10','$nama_jenjang10','$keterangan10','$saldo10','$status','$no_kasbon')";
      ...
      $insertquery11 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun11','$nama_akun11','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang11','$nama_jenjang11','$keterangan11','$saldo11','$status','$no_kasbon')";
      ...
      $insertquery11 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun11','$nama_akun11','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang11','$nama_jenjang11','$keterangan11','$saldo11','$status','$no_kasbon')";
      ...
      $insertquery12 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun12','$nama_akun12','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang12','$nama_jenjang12','$keterangan12','$saldo12','$status','$no_kasbon')";
      ...
      $insertquery12 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun12','$nama_akun12','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang12','$nama_jenjang12','$keterangan12','$saldo12','$status','$no_kasbon')";
      ...
      $insertquery13 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun13','$nama_akun13','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang13','$nama_jenjang13','$keterangan13','$saldo13','$status','$no_kasbon')";
      ...
      $insertquery13 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun13','$nama_akun13','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang13','$nama_jenjang13','$keterangan13','$saldo13','$status','$no_kasbon')";
      ...
      $insertquery14 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun14','$nama_akun14','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang14','$nama_jenjang14','$keterangan14','$saldo14','$status','$no_kasbon')";
      ...
      $insertquery14 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun14','$nama_akun14','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang14','$nama_jenjang14','$keterangan14','$saldo14','$status','$no_kasbon')";
      ...
      $insertquery15 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, kredit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun15','$nama_akun15','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang15','$nama_jenjang15','$keterangan15','$saldo15','$status','$no_kasbon')";
      ...
      $insertquery15 = "INSERT INTO transaksi_bank (no_transaksi, jenis_transaksi, kode_akun, nama_akun, kode_akun, nama_bank, tanggal, sumber_dana, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, keterangan, debit, status, no_kasbon) 
      VALUES('$kode_transaksi', '$jenis_transaksi','$kode_akun15','$nama_akun15','$kode_akun0','$nama_akun0','$tanggal','$sumber_dana','$kode_tahun','$tahun_ajaran','$kode_jenjang15','$nama_jenjang15','$keterangan15','$saldo15','$status','$no_kasbon')";
