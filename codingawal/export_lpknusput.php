...
echo '<tr>
    ...
    <td style="text-align: center;">' . $totalasetlancar . '</td>
</tr>';
...
echo '</table>';
    ...
    echo '<tr>
        ...
        echo '<tr>
            ...
            <td style="text-align: center;">' . $totalasettetap. '</td>
        </tr>';
    echo '<tr><td colspan="2"></td></tr>';
    echo '</table>';
    echo '</td>';
...
echo '<tr>
    ...
    <td style="text-align: center;">' . $totalhutangjkpendek . '</td>
</tr>';
...
$sql8 = "
SELECT akun.kode_akun, akun.nama_akun, akun.saldo_normal,
(
    SELECT COALESCE(SUM(kredit), 0) 
    FROM transaksi_memorial 
    WHERE akun.kode_akun = transaksi_memorial.kode_akun
