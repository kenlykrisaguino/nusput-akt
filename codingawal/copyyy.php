...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $kode_transaksi = $starting_number . "-" . strtoupper(substr($jenis_transaksi, 0, 15));
}
...
if (isset($_POST['simpan'])) {
    ...
    if ($jenis_transaksi === 'Penerimaan' && !empty($kode_akun)) {
      $insertquery1 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, debit)
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','$kode_tahun','$tahun_ajaran','','','$sumber_dana','','$akun_kas','$nama','$total')";

      $insertquery2 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, debit, kode_akun, nama_akun, kredit) 
      ...
      $insertquery1 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, kredit)
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','$kode_tahun','$tahun_ajaran','','','$sumber_dana','','$akun_kas','$nama','$total')";

      $insertquery2 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang1','$nama_jenjang1','','$keterangan1','','','','$kode_akun','$nama_akun','$saldo1')";  
      ...
      $insertquery3 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, debit, kode_akun, nama_akun, kredit) 
      ...
      $insertquery3 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang2','$nama_jenjang2','','$keterangan2','','','','$kode_akun','$nama_akun','$saldo2')"; 
      ...
      $insertquery4 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, debit, kode_akun, nama_akun, kredit) 
      ...
      $insertquery4 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang3','$nama_jenjang3','','$keterangan3','','','','$kode_akun','$nama_akun','$saldo3')";
      ...
      $insertquery5 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, debit, kode_akun, nama_akun, kredit) 
      ...
      $insertquery5 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang4','$nama_jenjang4','','$keterangan4','','','','$kode_akun','$nama_akun','$saldo4')";
      ...
      $insertquery6 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, debit, kode_akun, nama_akun, kredit) 
      ...
      $insertquery6 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang5','$nama_jenjang5','','$keterangan5','','','','$kode_akun','$nama_akun','$saldo5')";
      ...
      $insertquery7 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, debit, kode_akun, nama_akun, kredit) 
      ...
      $insertquery7  = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang6','$nama_jenjang6','','$keterangan6','','','','$kode_akun','$nama_akun','$saldo6')";
      ...
      $insertquery8 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, debit, kode_akun, nama_akun, kredit) 
      ...
      $insertquery8 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang7','$nama_jenjang7','','$keterangan7','','','','$kode_akun','$nama_akun','$saldo7')";
      ...
      $insertquery9 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, debit, kode_akun, nama_akun, kredit) 
      ...
      $insertquery9 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang8','$nama_jenjang8','','$keterangan8','','','','$kode_akun','$nama_akun','$saldo8')";
      ...
      $insertquery10 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, debit, kode_akun, nama_akun, kredit) 
      ...
      $insertquery10 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang9','$nama_jenjang9','','$keterangan9','','','','$kode_akun','$nama_akun','$saldo9')";
      ...
      $insertquery11 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, debit, kode_akun, nama_akun, kredit) 
      ...
      $insertquery11 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, kredit, kode_akun, nama_akun, debit) 
      ...
      $insertquery12 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, debit, kode_akun, nama_akun, kredit) 
      ...
      $insertquery12 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang11','$nama_jenjang11','','$keterangan11','','','','$kode_akun','$nama_akun','$saldo11')";
      ...
      $insertquery13 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, debit, kode_akun, nama_akun, kredit) 
      ...
      $insertquery13 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang12','$nama_jenjang12','','$keterangan12','','','','$kode_akun','$nama_akun','$saldo12')";
      ...
      $insertquery14 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, debit, kode_akun, nama_akun, kredit) 
      ...
      $insertquery14 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang13','$nama_jenjang13','','$keterangan13','','','','$kode_akun','$nama_akun','$saldo13')";
      ...
      $insertquery15 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, debit, kode_akun, nama_akun, kredit) 
      ...
      $insertquery15 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang14','$nama_jenjang14','','$keterangan14','','','','$kode_akun','$nama_akun','$saldo14')";
      ...
      $insertquery16 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, debit, kode_akun, nama_akun, kredit) 
      ...
      $insertquery16 = "INSERT INTO transaksi_kas (status, jenis_transaksi, no_transaksi, tanggal, kode_tahun, tahun_ajaran, kode_jenjang, nama_jenjang, sumber_dana, keterangan, akun_kas, nama, kredit, kode_akun, nama_akun, debit) 
      VALUES('$status','$jenis_transaksi','$kode_transaksi','$tanggal','','','$kode_jenjang15','$nama_jenjang15','','$keterangan15','','','','$kode_akun','$nama_akun','$saldo15')";
