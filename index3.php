...
if (empty($_SESSION['admintiga']) && empty($_SESSION['adminempat'])) {
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                <div class="sidebar-brand-icon rotate-n-0">
                    <img src="nusput.png" alt="Nusaputera Logo" style="width: 40px; height: 40px;">
                </div>
            ...
            <?php
            if (isset($_SESSION['admintiga']) || isset($_SESSION['adminempat'])) {
                $user = $_SESSION['admintiga'] ?? $_SESSION['adminempat'];
            }
