...
<?php
if ($_SESSION['adminutama']) {
   $user = $_SESSION['adminutama'];
}
...
?>
    ...
    <div id="collapseData" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
      ...
      <h6 class="collapse-header">Data Master :</h6>
        ...
        <a class="collapse-item" href="?page=lokasi">Lokasi</a>
        <a class="collapse-item" href="?page=kegiatan">Kegiatan</a>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseanggaran" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          ...
          <a class="collapse-item" href="?page=budgeting">Budgeting</a>
          </div>
        </div>
      </li>
  ...
  <li class="nav-item active">
    ...
    <div id="collapselaporan" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
      ...
      <h6 class="collapse-header">Jenis Laporan :</h6>
        ...
        <a class="collapse-item" href="?page=labarugi">Laba Rugi</a>
        <a class="collapse-item" href="?page=neracasaldo">Neraca Saldo</a>
        <a class="collapse-item" href="?page=neraca">Neraca</a>
...
$aksi = $_GET['aksi'];
   ...
   if ($page == "jenjang") {
    ...
    if ($aksi == "") {
      ...
      include "page/budgeting/input_budget.php";
    }
    else if ($aksi == "print") {
      include "page/budgeting/printbudget.php";
    }
    else if ($aksi == "ubah") {
      include "page/budgeting/ubah.php";
    }
    else if ($aksi == "realisasi") {
      include "page/budgeting/realisasi.php";
    }
    else if ($aksi == "form") {
      include "page/budgeting/form.php";
    }
  }
    ...
    if ($aksi == "") {
      ...
      include "page/aset/daftar_aset.php";
    }
    else if ($aksi == "data") {
      include "page/aset/data_aset2.php";
    }
  }
